    ...
    <div className="flex flex-col w-full pb-32">
      ...
      <section className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-mcm-cream dark:bg-mcm-dark border-b-8 border-mcm-dark dark:border-[#EBE7DF]">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 h-full min-h-[calc(100vh-6rem)]">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center items-start px-6 md:px-12 lg:px-16 pt-10 pb-16 lg:py-16 relative">
            <div className="absolute right-0 bottom-0 w-full md:w-3/4 h-full md:h-3/4 bg-mcm-orange rounded-tl-[150px] md:rounded-tl-[300px] -z-10 opacity-20" />
      ...
      <section className="max-w-7xl mx-auto w-full px-4 lg:px-8 mt-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-7">
          <ScrollReveal variant="slide-right" className="flex flex-col sm:flex-row sm:items-center justify-between border-b-8 border-mcm-dark dark:border-[#EBE7DF] pb-4 mb-8 gap-4">
            ...
            <NavLink to="/skills" className="mcm-btn-outline w-fit px-4 py-2 font-display font-bold uppercase border-4 shadow-[4px_4px_0px_0px_rgba(44,43,41,1)] dark:shadow-[4px_4px_0px_0px_#F4F1EA] bg-mcm-cream dark:bg-mcm-dark">
              {t('home.allskills')}
            </NavLink>
          </ScrollReveal>
        ...
        <div className="lg:col-span-5">
          <ScrollReveal variant="slide-left" className="flex flex-col sm:flex-row sm:items-center justify-between border-b-8 border-mcm-dark dark:border-[#EBE7DF] pb-4 mb-8 gap-4">
            ...
            <NavLink to="/certificates" className="mcm-btn-outline w-fit px-4 py-2 font-display font-bold uppercase border-4 shadow-[4px_4px_0px_0px_rgba(44,43,41,1)] dark:shadow-[4px_4px_0px_0px_#F4F1EA] bg-mcm-mustard">
              {t('home.viewall')}
            </NavLink>
          </ScrollReveal>
