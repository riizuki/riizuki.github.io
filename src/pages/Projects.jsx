        ...
        {Array.isArray(projectList) && projectList.map((project, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className={`relative h-full flex flex-col ${isFullWidth ? 'lg:items-end justify-start lg:justify-end' : (!isReversed ? 'lg:flex-row' : 'lg:flex-row-reverse')} border-4 md:border-8 border-mcm-dark dark:border-[#EBE7DF] shadow-[12px_12px_0px_0px_rgba(44,43,41,1)] dark:shadow-[12px_12px_0px_0px_#F4F1EA] bg-mcm-cream dark:bg-[#1F222B] overflow-hidden group ${isFullWidth ? 'min-h-[500px] lg:min-h-[600px]' : ''}`}>
                ...
                {isFullWidth ? (
                  <>
                    ...
                    />
                    <div className="absolute top-6 left-6 bg-mcm-mustard text-mcm-dark font-display font-bold px-4 py-2 border-4 border-mcm-dark shadow-[4px_4px_0px_0px_rgba(44,43,41,1)] uppercase tracking-widest z-10 rotate-[-2deg]">
                      No. 0{idx + 1}
                    </div>
                  </>
                ) : (
                  <div className={`relative overflow-hidden bg-mcm-dark w-full aspect-[4/3] border-b-4 md:border-b-8 border-mcm-dark dark:border-[#EBE7DF]`}>
                ...
                <div className={isFullWidth ? `relative z-10 bg-mcm-cream dark:bg-[#14161C] border-t-4 md:border-t-8 lg:border-t-0 lg:border-l-8 lg:border-t-8 border-mcm-dark dark:border-[#EBE7DF] p-6 md:p-10 w-full lg:w-[600px] lg:max-w-[60%] flex flex-col justify-center transform lg:translate-x-8 lg:translate-y-8 mt-auto lg:mt-0` : `p-6 md:p-10 flex flex-col flex-grow relative bg-mcm-cream dark:bg-[#14161C]`}>
